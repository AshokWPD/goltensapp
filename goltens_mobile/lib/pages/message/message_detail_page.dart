...
class _MessageDetailUserPageState extends State<MessageDetailUserPage> {
  ...
  Future<void> fetchMessage() async {
    ...
    try {
      ...
      setState(() {
        ...
        // showOptions =  res.data.messageReadByUser?.reply == null;
      });
    } catch (e) {
      if (mounted) {
  ...
  void onTimerFinished() async {
    showReplyOptionsDialog(null, null, context);
  }
  ...
  void showReplyOptionsDialog(
      int? modeIndex, int? replyIndex, BuildContext context) {
      ...
      body: RefreshIndicator(
        ...
        child: ListView.builder(
          ...
          itemBuilder: (BuildContext context, int index) {
            ...
            if (readObject.reply?.isNotEmpty == true && isUsersMessage) {
              return Padding(
                padding: const EdgeInsets.symmetric(
                  horizontal: 16.0,
                  vertical: 8.0,
                                ...
                                PopupMenuButton<String>(
                                  ...
                                  onSelected: (String value) {
                                    switch (value) {
                                      case 'change-option':
                                        final mode =
                                            readObject.mode == "In-Person Mode"
                                                ? 0
                                                : 1;
