...
class _AuthPageState extends State<AuthPage> {
  ...
  Future<void> sendOTP(String recipientEmail, String otp) async {
    ...
    const username = 'lapp4859@gmail.com';
    const password = 'gehvfdflyaofjvis';
    ...
    final message = Message()
      ..from = const Address(username, 'Goltens')
      ..recipients.add(recipientEmail)
      ..subject = 'Forgot password'
      ..text =
          'hello , \n Password Reset (Goltens Communication) \n Your Token: is: $otp';
  ...
  Future<void> forgotPassword() async {
    try {
      if (emailTextController.text.isEmpty) {
        ...
        sendOTP(emailTextController.text, data.token);
