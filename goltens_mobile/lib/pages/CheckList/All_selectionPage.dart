...
class All_SelectionPage extends StatefulWidget {
  final List<String> selectedItems;
  final String Assigner;
  final String Date;

  const All_SelectionPage(this.selectedItems,
      {Key? key, required this.Assigner, required this.Date})
      : super(key: key);

  @override
  State<All_SelectionPage> createState() => _All_SelectionPageState();
}

class _All_SelectionPageState extends State<All_SelectionPage> {
  int currentPage = 1;
  int totalPages = 1;
  int limit = 1000000;
...
// Inside the buildBody method
  ...
  void sendNotifications(
    ...
    Map<String, dynamic> requestData = {
      ...
      "body": body,
      "route": route,
      "checlistId": checklistId,
      "checlistTitle": checklistTitle,
    ...
    try {
      ...
      http.Response response = await http.post(
        Uri.parse('https://goltens.in/api/v1/notifications/assiginuser_notify'),
      ...
      if (response.statusCode == 200) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(
                'Failed to send notifications. Error: ${response.statusCode}'),
                    ...
                    ElevatedButton(
                      ...
                      onPressed: () {
                        sendNotifications(
                          ...
                          "${widget.Assigner} assigned you a Checklist @ ${widget.Date}",
                          '/sub-emp checklist',
                          'Checklist ID',
                          "${widget.selectedItems}",
                          'Checklist Type',
