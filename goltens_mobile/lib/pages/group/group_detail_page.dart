    ...
    return RefreshIndicator(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
          ...
          List<GetMessagesResponseData> reversedMessage = messages;
          GetMessagesResponseData message = reversedMessage[index];
        ...
        body: Stack(
          children: [
            ...
            Positioned(
              ...
              left: 0,
              right: 0,
              child: ChatTextField(onMessageSend: sendMessage,isSingleMessage: true,groupId: group.id,),
            )
          ],
        ),
      ),
