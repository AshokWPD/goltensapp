...
class AllSelectionPage extends StatefulWidget {
  ...
  @override
  State<AllSelectionPage> createState() => _AllSelectionPageState();
}

class _AllSelectionPageState extends State<AllSelectionPage> {
  int currentPage = 1;
  int totalPages = 1;
  int limit = 1000000;
